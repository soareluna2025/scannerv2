...
function mdRenderML(d){
  ...
  out+='<style>'
    ...
    +'.mlx-zone{font-size:17px;font-weight:800;color:#d2dbff;letter-spacing:.6px;margin:24px 0 10px;display:flex;align-items:center;gap:9px;border-left:3px solid #00e5b8;padding-left:11px;line-height:1.2}'
    +'.mlx-zone .gn,.mlx-grpd .gn{font-size:12px;font-weight:700;color:#8b9bb4;background:rgba(255,255,255,.06);border-radius:10px;padding:2px 9px}'
    +'.mlx-grpd{margin:24px 0 0}'
    +'.mlx-grpd>summary{cursor:pointer;list-style:none;display:flex;align-items:center;gap:9px;font-size:17px;font-weight:800;color:#b6c1d4;text-transform:uppercase;letter-spacing:.6px;margin:0 0 10px;border-left:3px solid #5a6a80;padding-left:11px;line-height:1.2}'
    +'.mlx-grpd>summary::-webkit-details-marker{display:none}'
    +'.mlx-grpd>summary .arw{margin-left:auto;transition:transform .2s;color:#8b9bb4;font-size:13px}'
    ...
    +'details.mlx-acc{margin-top:24px;border:1px solid var(--bor);border-radius:10px;overflow:hidden}'
    +'details.mlx-acc>summary{cursor:pointer;padding:11px 12px 11px 11px;font-size:17px;font-weight:800;color:#b6c1d4;letter-spacing:.6px;list-style:none;background:rgba(255,255,255,.02);border-left:3px solid #5a6a80;display:flex;align-items:center;gap:9px}'

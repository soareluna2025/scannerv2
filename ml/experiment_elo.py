...
def main():
    ...
    lines.append("")
    lines.append("Notă: grila e ELO standard (K const + avantaj teren, fără decay/greutăți);")
    lines.append("baseline-ul e logica COMPLETĂ de producție. Niciun cod de producție atins.")
